...
function App() {
  ...
  return (
    <div className="flex flex-col">
      <div
        className={`fixed top-0 left-0 w-full px-10 py-4 flex z-50 justify-between backdrop-blur-lg bg-white/30 border border-white/10 
 dark:bg-background transition duration-1000 ease-in-out`}
      >
        <div className="flex gap-3 items-center">
          <img src={yelpLogo} alt="Yelp Logo" className="w-7 h-7" />
          <h1 className="font-semibold text-lg">MenuMeter</h1>
        </div>
      ...
      <div className="px-10 mt-[60px]">
        ...
        <h3 className=" text-sm text-gray-500 max-w-[700px]">
          ...
          countless reviews? <br className="md:flex hidden" /> Generate a menu
          for your restaurant of choice and see ratings for each meal.
        </h3>
